      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f3f4] dark:border-b-gray-800 px-6 lg:px-10 py-4 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="flex flex-1 justify-end gap-8">
          <div className="hidden lg:flex items-center gap-9">
            <Link href="/" className="text-[#111618] dark:text-gray-200 text-sm font-medium leading-normal hover:text-primary transition-colors">首頁</Link>
            <Link href="/courses" className="text-[#111618] dark:text-gray-200 text-sm font-medium leading-normal hover:text-primary transition-colors">課程列表</Link>
            <Link href="/teachers" className="text-[#111618] dark:text-gray-200 text-sm font-medium leading-normal hover:text-primary transition-colors">師資介紹</Link>
            <Link href="/reviews" className="text-[#111618] dark:text-gray-200 text-sm font-medium leading-normal hover:text-primary transition-colors">學員心得</Link>
            <Link href="/contact" className="text-[#111618] dark:text-gray-200 text-sm font-medium leading-normal hover:text-primary transition-colors">聯絡我們</Link>
          </div>
          <div className="flex gap-4 items-center">
            <button className="lg:hidden text-[#111618] dark:text-white">
              <span className="material-symbols-outlined">menu</span>
            </button>
            <Link href="/auth/login" className="hidden lg:flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-6 bg-primary hover:bg-[#0fa0d1] transition-colors text-white text-sm font-bold leading-normal tracking-[0.015em] shadow-lg shadow-primary/20">
        ...
        <div className="px-4 flex flex-1 items-center justify-center py-12 md:py-20">
          <div className="w-full max-w-[480px] bg-white dark:bg-gray-800 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none border border-slate-100 dark:border-gray-700 p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center mb-8">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-[#111618] dark:text-white tracking-tight mb-3">重設密碼</h2>
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-6">
              ...
              <div className="space-y-5">
                <div className="space-y-2 text-left">
                  <label className="text-sm font-bold text-[#111618] dark:text-gray-200 ml-1" htmlFor="new_password">新密碼</label>
                  <div className="relative group">
                    ...
                    />
                    <button className="absolute inset-y-0 right-0 pr-4 flex items-center cursor-pointer text-slate-400 hover:text-primary transition-colors" type="button">
                  ...
                  <div className="pt-1 px-1">
                    ...
                    <ul className="mt-2 space-y-1.5 text-xs text-slate-500 dark:text-gray-400">
                      <li className="flex items-center gap-2 text-emerald-500 font-medium">
                        ...
                        <span className="text-slate-700 dark:text-gray-300">至少 8 個字元</span>
                      </li>
                ...
                <div className="space-y-2 text-left">
                  <label className="text-sm font-bold text-[#111618] dark:text-gray-200 ml-1" htmlFor="confirm_password">確認新密碼</label>
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-primary transition-colors">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 dark:border-gray-700/50 text-center">
              <Link href="/auth/login" className="inline-flex items-center gap-2 text-sm font-bold text-slate-500 dark:text-gray-400 hover:text-primary transition-colors group">
      ...
      <footer className="bg-white dark:bg-gray-900 border-t border-[#f0f3f4] dark:border-gray-800 py-10 px-6 lg:px-40">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            <Link href="/legal/privacy" className="text-[#617f89] dark:text-gray-500 hover:text-primary transition-colors text-sm font-medium">隱私權政策</Link>
            <Link href="/legal/terms" className="text-[#617f89] dark:text-gray-500 hover:text-primary transition-colors text-sm font-medium">服務條款</Link>
            <Link href="/faq" className="text-[#617f89] dark:text-gray-500 hover:text-primary transition-colors text-sm font-medium">常見問題</Link>
          </div>
        </div>
      </footer>
    </div>
