      ...
      <header className="w-full bg-surface-light/80 dark:bg-surface-dark/80 backdrop-blur-md border-b border-border-light dark:border-border-dark px-8 py-4 flex justify-between items-center sticky top-0 z-10 transition-all">
        <div className="flex flex-col">
          ...
          <p className="text-text-sub dark:text-gray-400 text-sm mt-0.5">
            目前共有 <span className="text-primary font-bold">{activeCount}</span> 位活躍學生
          </p>
        </div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <div className="lg:col-span-4 flex flex-col gap-6">
                          ...
                          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-border-light dark:border-border-dark p-5">
                            <h4 className="text-xs font-bold text-text-sub uppercase tracking-wider mb-4">系統資訊</h4>
                            <div className="space-y-3 text-sm">
                              <div className="flex justify-between items-center border-b border-dashed border-border-light dark:border-border-dark pb-2">
                                <span className="text-text-sub flex items-center gap-2"><span className="material-symbols-outlined text-[14px]">calendar_today</span> 註冊日期</span>
                                <span className="font-medium text-slate-800 dark:text-gray-300">{selectedStudent.created_at ? new Date(selectedStudent.created_at).toLocaleDateString() : 'N/A'}</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span className="text-text-sub flex items-center gap-2"><span className="material-symbols-outlined text-[14px]">history</span> 最後更新</span>
                                <span className="font-medium text-slate-800 dark:text-gray-300">{selectedStudent.updated_at ? new Date(selectedStudent.updated_at).toLocaleString() : 'N/A'}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="lg:col-span-8 flex flex-col gap-6">
                          ...
                          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-border-light dark:border-border-dark p-6 relative overflow-hidden">
                            <div className="flex items-center gap-3 mb-5">
                              ...
                              <h3 className="font-bold text-slate-800 dark:text-white">課程與學習狀態</h3>
                            </div>
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="flex flex-col gap-1.5 justify-center">
                            ...
                            <p className="text-xs text-text-sub mt-1">
                              加入時間: {selectedStudent.created_at ? new Date(selectedStudent.created_at).toLocaleDateString() : 'N/A'}
                            </p>
                          </div>
                        </div>
