                  ...
                  {filteredCourses.map((course) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <div
                            className={`size-12 rounded-lg bg-${course.iconColor}-100 dark:bg-${course.iconColor}-900/30 text-${course.iconColor}-600 dark:text-${course.iconColor}-400 flex items-center justify-center flex-shrink-0 shadow-sm`}
                          >
                    ...
                    <div className="flex-1 overflow-y-auto p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2 space-y-4">
                          <h3 className="font-bold text-slate-800 dark:text-white text-sm border-b pb-2 mb-2">
                            基本資訊
                          </h3>
